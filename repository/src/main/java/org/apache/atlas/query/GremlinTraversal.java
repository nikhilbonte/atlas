...
public class GremlinTraversal {
    ...
    private final AtlasGraphTraversal  graphTraversal;
    private final SelectClauseMetadata selectClauseMetadata;
    private final AtlasDSL.QueryMetadata queryMetadata;

    public GremlinTraversal(AtlasGraphTraversal graphTraversal, SelectClauseMetadata selectClauseMetadata, final AtlasDSL.QueryMetadata queryMetadata) {
    ...
    public boolean hasValidSelectClause() {
        return Objects.nonNull(selectClauseMetadata) && !selectClauseMetadata.isSelectNoop();
    }
